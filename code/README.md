...
```julia
trixi_include(joinpath("code", "elixir_burgers_mms.jl"), boundary_conditions = (x_neg = boundary_condition_inflow_ec,
                                                                                x_pos = boundary_condition_outflow_ec));
```

To obtain the local Lax-Friedrichs result use
```julia
trixi_include(joinpath("code", "elixir_burgers_mms.jl"), boundary_conditions = (x_neg = boundary_condition_inflow_llf,
